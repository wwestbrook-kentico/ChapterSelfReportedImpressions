<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Default2.aspx.cs" Inherits="_tools_ChapterSelfReportedImpressions_Default2" %>
                ...
                <tr>
                    <td>
                        <table class="table3" id="Tbl_Hdr" runat="server">
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="grdvwdata" runat="server" AutoGenerateColumns="False" CssClass="mydatagrid" FooterStyle-ForeColor="White" PagerStyle-CssClass="pager" ShowFooter="true" HeaderStyle-CssClass="header" FooterStyle-Font-Bold="true" FooterStyle-CssClass="rows" RowStyle-CssClass="rows" ShowHeaderWhenEmpty="True" EmptyDataRowStyle-CssClass="header" EmptyDataRowStyle-Font-Bold="true" EmptyDataRowStyle-ForeColor="White" EmptyDataText="No Records Found" DataKeyNames="Rec_ID" OnRowDataBound="grdvwdata_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="KPI3_PA1:<br>Number of Stories Developed" HeaderStyle-BackColor="#99ccff" HeaderStyle-ForeColor="#4a0d66" HeaderStyle-Font-Bold="true">
                                                <HeaderTemplate>
                                                    <div class="tooltipCustom">KPI3_PA1:<br>Number of Stories Developed<span class="tooltiptext">KPI3_PA1:<br>Number of Stories Developed</span></div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="KPI3-PA2:<br>Number of Media Engagements with Reporters" HeaderStyle-BackColor="#99ccff" HeaderStyle-ForeColor="#4a0d66" HeaderStyle-Font-Bold="true">
                                                <HeaderTemplate>
                                                    <div class="tooltipCustom">KPI3-PA2:<br>Number of Media Engagements with Reporters<span class="tooltiptext">KPI3-PA2:<br>Number of Media Engagements with Reporters</span></div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="KPI3-PA3:<br>Number of Stories Placed" HeaderStyle-BackColor="#99ccff" HeaderStyle-ForeColor="#4a0d66" HeaderStyle-Font-Bold="true">
                                                <HeaderTemplate>
                                                    <div class="tooltipCustom">KPI3-PA3:<br>Number of Stories Placed<span class="tooltiptext">KPI3-PA3:<br>Number of Stories Placed</span></div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="KPI3-MS1:<br>Social Media Earned Impressions" HeaderStyle-BackColor="#99ccff" HeaderStyle-ForeColor="#4a0d66" HeaderStyle-Font-Bold="true">
                                                <HeaderTemplate>
                                                    <div class="tooltipCustom">KPI3-MS1:<br>Social Media Earned Impressions<span class="tooltiptext">KPI3-MS1:<br>Social Media Earned Impressions</span></div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="KPI3-MS2:<br>Traditional Earned Media Impressions" HeaderStyle-BackColor="#99ccff" HeaderStyle-ForeColor="#4a0d66" HeaderStyle-Font-Bold="true">
                                                <HeaderTemplate>
                                                    <div class="tooltipCustom">KPI3-MS2:<br>Traditional Earned Media Impressions<span class="tooltiptext">KPI3-MS2:<br>Traditional Earned Media Impressions</span></div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="KPI4-MS1:<br>Social Media Paid Impressions" HeaderStyle-BackColor="#ff9900" HeaderStyle-ForeColor="#4a0d66" HeaderStyle-Font-Bold="true">
                                                <HeaderTemplate>
                                                    <div class="tooltipCustom">KPI4-MS1:<br>Social Media Paid Impressions<span class="tooltiptext">KPI4-MS1:<br>Social Media Paid Impressions</span></div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="KPI4-MS2:<br>Paid Advertising Impressions" HeaderStyle-BackColor="#ff9900" HeaderStyle-ForeColor="#4a0d66" HeaderStyle-Font-Bold="true">
                                                <HeaderTemplate>
                                                    <div class="tooltipCustom">KPI4-MS2:<br>Paid Advertising Impressions<span class="tooltiptext">KPI4-MS2:<br>Paid Advertising Impressions</span></div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="KPI4_PA1_Value:<br>Advertising & Social Media Spend" HeaderStyle-BackColor="#ff9900" HeaderStyle-ForeColor="#4a0d66" HeaderStyle-Font-Bold="true">
                                                <HeaderTemplate>
                                                    <div class="tooltipCustom">KPI4_PA1_Value:<br>Advertising & Social Media Spend<span class="tooltiptext">KPI4_PA1_Value:<br>Advertising & Social Media Spend</span></div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="KPI4-MS3:<br>Donated Impressions" HeaderStyle-BackColor="#ff9900" HeaderStyle-ForeColor="#4a0d66" HeaderStyle-Font-Bold="true">
                                                <HeaderTemplate>
                                                    <div class="tooltipCustom">KPI4-MS3:<br>Donated Impressions<span class="tooltiptext">KPI4-MS3:<br>Donated Impressions</span></div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
