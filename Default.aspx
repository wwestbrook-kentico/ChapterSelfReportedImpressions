<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Default.aspx.cs" Inherits="_tools_ChapterSelfReportedImpressions_Default" %>
                                    ...
                                    <asp:GridView ID="grdvwdata" runat="server" AutoGenerateColumns="False" CssClass="mydatagrid" FooterStyle-ForeColor="White" PagerStyle-CssClass="pager" ShowFooter="true" HeaderStyle-CssClass="header" FooterStyle-Font-Bold="true" FooterStyle-CssClass="rows" RowStyle-CssClass="rows" ShowHeaderWhenEmpty="True" EmptyDataRowStyle-CssClass="header" EmptyDataRowStyle-Font-Bold="true" EmptyDataRowStyle-ForeColor="White" EmptyDataText="No Records Found" DataKeyNames="Rec_ID">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="KPI3-MS2:<br>Traditional Earned Media Impressions" HeaderStyle-BackColor="#99ccff" HeaderStyle-ForeColor="#4a0d66" HeaderStyle-Font-Bold="true">
                                                <HeaderTemplate>
                                                    <div class="tooltipCustom">KPI3-MS2:<br>Traditional Earned Media Impressions<span class="tooltiptext">Impressions garnered through public/media relations. Monitored by Home Office vendors (Symscio, Burrelle's, Critical Mention, TV1) – This data is not editable, fed from Data Warehouse</span></div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="KPI4-MS1:<br>Social Media Paid Impressions" HeaderStyle-BackColor="#ff9900" HeaderStyle-ForeColor="#4a0d66" HeaderStyle-Font-Bold="true">
                                                <HeaderTemplate>
                                                    <div class="tooltipCustom">KPI4-MS1:<br>Social Media Paid Impressions<span class="tooltiptext">Impressions as a result of paid social media buys</span></div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="KPI4-MS2:<br>Paid Advertising Impressions" HeaderStyle-BackColor="#ff9900" HeaderStyle-ForeColor="#4a0d66" HeaderStyle-Font-Bold="true">
                                                <HeaderTemplate>
                                                    <div class="tooltipCustom">KPI4-MS2:<br>Paid Advertising Impressions<span class="tooltiptext">Impressions as a result of paid advertising placements on channels such as television, radio, print and digital</span></div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="KPI4_PA1_Value:<br>Advertising & Social Media Spend" HeaderStyle-BackColor="#ff9900" HeaderStyle-ForeColor="#4a0d66" HeaderStyle-Font-Bold="true">
                                                <HeaderTemplate>
                                                    <div class="tooltipCustom">KPI4_PA1_Value:<br>Advertising & Social Media Spend<span class="tooltiptext">Dollars spent for any advertising and/or paid social media.</span></div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="KPI4-MS3:<br>Donated Impressions" HeaderStyle-BackColor="#ff9900" HeaderStyle-ForeColor="#4a0d66" HeaderStyle-Font-Bold="true">
                                                <HeaderTemplate>
                                                    <div class="tooltipCustom">KPI4-MS3:<br>Donated Impressions<span class="tooltiptext">Impressions from a conventional paid tactic that are donated or stem from a media sponsorship (at no cost to the Alzheimer’s Association).</span></div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
