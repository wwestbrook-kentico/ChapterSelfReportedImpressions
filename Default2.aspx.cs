...
public partial class _tools_ChapterSelfReportedImpressions_Default2 : System.Web.UI.Page
{
    ...
    protected void grdvwdata_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            int i = e.Row.RowIndex * 9;

            TextBox TxtBx_KPI3_PA1_Value = (TextBox)e.Row.FindControl("TxtBx_KPI3_PA1_Value");
            TextBox TxtBx_KPI3_PA2_Value = (TextBox)e.Row.FindControl("TxtBx_KPI3_PA2_Value");
            TextBox TxtBx_KPI3_PA3_Value = (TextBox)e.Row.FindControl("TxtBx_KPI3_PA3_Value");
            TextBox TxtBx_KPI3_MS1_Value = (TextBox)e.Row.FindControl("TxtBx_KPI3_MS1_Value");
            //TextBox TxtBx_KPI3_MS2_Value = (TextBox)e.Row.FindControl("TxtBx_KPI3_MS2_Value");
            TextBox TxtBx_KPI4_MS1_Value = (TextBox)e.Row.FindControl("TxtBx_KPI4_MS1_Value");
            TextBox TxtBx_KPI4_MS2_Value = (TextBox)e.Row.FindControl("TxtBx_KPI4_MS2_Value");
            TextBox TxtBx_KPI4_PA1_Value = (TextBox)e.Row.FindControl("TxtBx_KPI4_PA1_Value");
            TextBox TxtBx_KPI4_MS3_Value = (TextBox)e.Row.FindControl("TxtBx_KPI4_MS3_Value");

            Label Lbl_KPI3_PA1_Value = (Label)e.Row.FindControl("Lbl_KPI3_PA1_Value");
            Label Lbl_KPI3_PA2_Value = (Label)e.Row.FindControl("Lbl_KPI3_PA2_Value");
            Label Lbl_KPI3_PA3_Value = (Label)e.Row.FindControl("Lbl_KPI3_PA3_Value");
            Label Lbl_KPI3_MS1_Value = (Label)e.Row.FindControl("Lbl_KPI3_MS1_Value");
            //Label Lbl_KPI3_MS2_Value = (Label)e.Row.FindControl("Lbl_KPI3_MS2_Value");
            Label Lbl_KPI4_MS1_Value = (Label)e.Row.FindControl("Lbl_KPI4_MS1_Value");
            Label Lbl_KPI4_MS2_Value = (Label)e.Row.FindControl("Lbl_KPI4_MS2_Value");
            Label Lbl_KPI4_PA1_Value = (Label)e.Row.FindControl("Lbl_KPI4_PA1_Value");
            Label Lbl_KPI4_MS3_Value = (Label)e.Row.FindControl("Lbl_KPI4_MS3_Value");

            TxtBx_KPI3_PA1_Value.Attributes.Add("tabindex", (i + 1).ToString());
            Lbl_KPI3_PA1_Value.Attributes.Add("tabindex", (i + 1).ToString());

            TxtBx_KPI3_PA2_Value.Attributes.Add("tabindex", (i + 2).ToString());
            Lbl_KPI3_PA2_Value.Attributes.Add("tabindex", (i + 2).ToString());

            TxtBx_KPI3_PA3_Value.Attributes.Add("tabindex", (i + 3).ToString());
            Lbl_KPI3_PA3_Value.Attributes.Add("tabindex", (i + 3).ToString());

            TxtBx_KPI3_MS1_Value.Attributes.Add("tabindex", (i + 4).ToString());
            Lbl_KPI3_MS1_Value.Attributes.Add("tabindex", (i + 4).ToString());

            //TxtBx_KPI3_MS2_Value.Attributes.Add("tabindex", (i + 5).ToString());
            //Lbl_KPI3_MS2_Value.Attributes.Add("tabindex", (i + 5).ToString());

            TxtBx_KPI4_MS1_Value.Attributes.Add("tabindex", (i + 5).ToString());
            Lbl_KPI4_MS1_Value.Attributes.Add("tabindex", (i + 5).ToString());

            TxtBx_KPI4_MS2_Value.Attributes.Add("tabindex", (i + 6).ToString());
            Lbl_KPI4_MS2_Value.Attributes.Add("tabindex", (i + 6).ToString());

            TxtBx_KPI4_PA1_Value.Attributes.Add("tabindex", (i + 7).ToString());
            Lbl_KPI4_PA1_Value.Attributes.Add("tabindex", (i + 7).ToString());

            TxtBx_KPI4_MS3_Value.Attributes.Add("tabindex", (i + 8).ToString());
            Lbl_KPI4_MS3_Value.Attributes.Add("tabindex", (i + 8).ToString());

            if (e.Row.RowIndex == 0)
            {
                TxtBx_KPI3_PA1_Value.Focus();
                Lbl_KPI3_PA1_Value.Focus();
            }

            //Int16 j = (Int16)(e.Row.RowIndex * 9);

            //TxtBx_KPI3_PA1_Value.TabIndex = (Int16)(j + 1);
            //TxtBx_KPI3_PA2_Value.TabIndex = (Int16)(j + 2);
            //TxtBx_KPI3_PA3_Value.TabIndex = (Int16)(j + 3);
            //TxtBx_KPI3_MS1_Value.TabIndex = (Int16)(j + 4);
            ////TxtBx_KPI3_MS2_Value.TabIndex = (Int16)(j + 5);
            //TxtBx_KPI4_MS1_Value.TabIndex = (Int16)(j + 5);
            //TxtBx_KPI4_MS2_Value.TabIndex = (Int16)(j + 6);
            //TxtBx_KPI4_PA1_Value.TabIndex = (Int16)(j + 7);
            //TxtBx_KPI4_MS3_Value.TabIndex = (Int16)(j + 8);

            //Lbl_KPI3_PA1_Value.TabIndex = (Int16)(j + 1);
            //Lbl_KPI3_PA2_Value.TabIndex = (Int16)(j + 2);
            //Lbl_KPI3_PA3_Value.TabIndex = (Int16)(j + 3);
            //Lbl_KPI3_MS1_Value.TabIndex = (Int16)(j + 4);
            ////Lbl_KPI3_MS2_Value.TabIndex = (Int16)(j + 5);
            //Lbl_KPI4_MS1_Value.TabIndex = (Int16)(j + 5);
            //Lbl_KPI4_MS2_Value.TabIndex = (Int16)(j + 6);
            //Lbl_KPI4_PA1_Value.TabIndex = (Int16)(j + 7);
            //Lbl_KPI4_MS3_Value.TabIndex = (Int16)(j + 8);
        }
    }
}